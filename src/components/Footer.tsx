      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/services#software" className="text-gray-300 hover:text-white transition-colors">Software Development</Link>
              </li>
              <li>
                <Link to="/services#web" className="text-gray-300 hover:text-white transition-colors">Web Development</Link>
              </li>
              <li>
                <Link to="/services#design" className="text-gray-300 hover:text-white transition-colors">Graphic Design</Link>
              </li>
              <li>
                <Link to="/services#brand" className="text-gray-300 hover:text-white transition-colors">Brand Strategy</Link>
              </li>
              <li>
                <Link to="/services#social" className="text-gray-300 hover:text-white transition-colors">Social Media Services</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:info@meiflume.com" className="text-gray-300 hover:text-white transition-colors">
                  info@meiflume.com
                </a>
              </li>
            </ul>
