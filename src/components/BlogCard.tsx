...
const BlogCard = ({ blog, index }: BlogCardProps) => {
  return (
    ...
    >
      <div className="glass-card h-full flex flex-col border hover:shadow-lg hover:border-brand-teal/20 transition-all duration-300 hover:-translate-y-1 overflow-hidden">
