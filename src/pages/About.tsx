...
const About = () => {
  return (
    <>
      <Helmet>
        <title>About MeiFlume - Digital Transformation Experts</title>
        <meta name="description" content="Learn about MeiFlume's mission, vision, and values. We're a team of passionate digital transformation experts dedicated to helping businesses thrive in the digital age." />
        <meta name="keywords" content="digital transformation, business innovation, technology consulting, MeiFlume about, digital solutions" />
        <link rel="canonical" href="https://meiflume.com/about" />
        <meta property="og:title" content="About MeiFlume - Digital Transformation Experts" />
        <meta property="og:description" content="Learn about MeiFlume's mission, vision, and values. We're a team of passionate digital transformation experts dedicated to helping businesses thrive in the digital age." />
        ...
        <section className="py-20 bg-brand-gray">
          <div className="container mx-auto px-4 md:px-6">
            <div className="flex flex-col lg:flex-row items-center gap-12">
              ...
              >
                <h1 className="section-title">About MeiFlume</h1>
